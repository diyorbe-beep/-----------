...
import AmbulanceAnimation from '../components/AmbulanceAnimation.jsx'
    ...
    return (
      <main className="container">
        <div style={{ 
          ...
          {/* Tez yordam mashinasi animatsiyasi */}
          ...
          <div style={{ textAlign: 'center' }}>
            <h3 style={{ margin: '0 0 8px', color: 'var(--txt)' }}>
              🚑 Tez yordam mashinasi ketmoqda...
            </h3>
            <p className="muted" style={{ fontSize: '16px', margin: 0 }}>
              Professional shifokorlar topilmoqda
            </p>
          </div>
