...
const DoctorCard = ({ doctor }) => {
  return (
    ...
    >
      {/* Header */}
      <div className="doctor-card-header" style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
        ...
        <div style={{ flex: 1 }}>
          <h3 className="doctor-name" style={{ margin: 0, color: 'var(--txt)', fontSize: '18px' }}>
            {doctor.profiles?.full_name}
          </h3>
          <p className="doctor-specialization muted" style={{ margin: '2px 0 0', fontSize: '14px' }}>
